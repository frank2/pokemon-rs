...
pub const RUBYSAPPHIREEMERALD: Pokedex = Pokedex {
    game: Some(PokemonGame::RubySapphireEmerald),
    rules: GEN2_RULES,
    pokemon: &[
        ABRA,
        ABSOL,
...
pub const FIREREDLEAFGREEN: Pokedex = Pokedex {
    game: Some(PokemonGame::FireRedLeafGreen),
    rules: GEN2_RULES,
    pokemon: &[
        ABRA,
        AERODACTYL,
...
pub const DIAMONDPEARL: Pokedex = Pokedex {
    game: Some(PokemonGame::DiamondPearl),
    rules: GEN2_RULES,
    pokemon: &[
        ABOMASNOW,
        ABRA,
...
pub const PLATINUM: Pokedex = Pokedex {
    game: Some(PokemonGame::Platinum),
    rules: GEN2_RULES,
    pokemon: &[
        ABOMASNOW,
        ABRA,
